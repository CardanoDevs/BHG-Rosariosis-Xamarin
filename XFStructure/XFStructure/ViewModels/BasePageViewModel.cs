...
namespace XFStructure.ViewModels
{
    public class BasePageViewModel : BasePageModel, IBasePageModel
    {
        ...
        public NavigationService Navigation => navigation ?? (navigation = new NavigationService());
        ...
        public async Task<TResult> PerformAPICall<TResult>(Func<Task<TResult>> serviceCallAction)
        {
